...
export const MicOffIcon = ({ className = "" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2M13 10V5a3 3 0 00-6 0v5" />
  </svg>
);
...
export const ShareScreenIcon = ({ className = "" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const SignalIcon = ({ className = "", quality = "good" }) => {
  const getColor = () => {
    if (quality === "excellent") return "#4CAF50";
    if (quality === "good") return "#8BC34A";
    if (quality === "fair") return "#FFC107";
    return "#F44336";
  };

  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" style={{ color: getColor() }}>
      <path d="M1 9h2v8H1zm4 4h2v4H5zm4-4h2v8H9zm4 0h2v4h-2zm4 0h2v8h-2z" />
    </svg>
  );
};
